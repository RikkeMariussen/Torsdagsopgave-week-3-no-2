/*5.a In your tab Datamatik, make a new method called isClassmates(). The method should take 
two Student objects as parameters. The method should return a boolean.
...
class Student {
  ...
  boolean isClassmates(Student no1, Student no2) {  
  return no1.datamatikerTeam == no2.datamatikerTeam ;  
  }
